        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BonusHealth = table.Column<int>(type: "integer", nullable: true),
                    BonusMana = table.Column<int>(type: "integer", nullable: true),
                    BonusArmor = table.Column<int>(type: "integer", nullable: true),
                    BonusDamage = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LevelUpCost = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TradeLots_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TradeLotId = table.Column<Guid>(type: "uuid", nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Purchases_TradeLots_TradeLotId",
                        column: x => x.TradeLotId,
                        principalTable: "TradeLots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Purchases_TradeLotId",
                table: "Purchases",
                column: "TradeLotId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportTickets_AuthorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TradeLots_ItemId",
                table: "TradeLots",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_TradeLots_Status",
                table: "TradeLots",
                column: "Status");
